...
namespace AffinidiTdk.VaultDataManagerClient.Model
{
    ...
    public partial class UnexpectedError : IValidatableObject
    {
        ...
        public UnexpectedError(NameEnum name = default, MessageEnum message = default, HttpStatusCodeEnum httpStatusCode = default, string traceId = default, List<InvalidParameterErrorDetailsInner> details = default)
        {
            this.Name = name;
