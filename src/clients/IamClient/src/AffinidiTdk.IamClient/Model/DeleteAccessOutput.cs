...
namespace AffinidiTdk.IamClient.Model
{
    ...
    /// DeleteAccessOutput
    /// </summary>
    [DataContract(Name = "DeleteAccessOutput")]
    public partial class DeleteAccessOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAccessOutput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteAccessOutput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAccessOutput" /> class.
        /// </summary>
        /// <param name="success">success (required).</param>
        public DeleteAccessOutput(bool success = default)
        {
