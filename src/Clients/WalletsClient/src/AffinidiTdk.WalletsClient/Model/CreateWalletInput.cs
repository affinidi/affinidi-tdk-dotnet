...
namespace AffinidiTdk.WalletsClient.Model
{
    ...
    /// CreateWalletInput
    /// </summary>
    [DataContract(Name = "CreateWalletInput")]
    public partial class CreateWalletInput : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWalletInput" /> class.
        /// </summary>
        /// <param name="name">The name of the wallet.</param>
        /// <param name="description">The description of the wallet.</param>
        /// <param name="didMethod">Define how DID of your wallet is created and resolved.</param>
        /// <param name="didWebUrl">URL of the DID. Required if the did method is web.</param>
        public CreateWalletInput(string name = default, string description = default, DidMethodEnum? didMethod = default, string didWebUrl = default)
        {
            this.Name = name;
