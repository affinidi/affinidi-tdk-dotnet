...
namespace AffinidiTdk.WalletsClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SignCredentialsDm1LdInputDto")]
    public partial class SignCredentialsDm1LdInputDto : IValidatableObject
    {
        ...
        protected SignCredentialsDm1LdInputDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SignCredentialsDm1LdInputDto" /> class.
        /// </summary>
        ...
        public SignCredentialsDm1LdInputDto(Object unsignedCredential = default, bool revocable = default)
        {
            ...
            {
                throw new ArgumentNullException("unsignedCredential is a required property for SignCredentialsDm1LdInputDto and cannot be null");
            }
