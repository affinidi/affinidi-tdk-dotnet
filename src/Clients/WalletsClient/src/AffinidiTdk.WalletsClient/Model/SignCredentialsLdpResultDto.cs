...
namespace AffinidiTdk.WalletsClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "signCredentialsLdpResultDto")]
    public partial class SignCredentialsLdpResultDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignCredentialsLdpResultDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SignCredentialsLdpResultDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SignCredentialsLdpResultDto" /> class.
        /// </summary>
        /// <param name="credential">Signed credential can be in Dm2Ld format (required).</param>
        public SignCredentialsLdpResultDto(Object credential = default)
        {
            // to ensure "credential" is required (not null)
            if (credential == null)
            {
                throw new ArgumentNullException("credential is a required property for SignCredentialsLdpResultDto and cannot be null");
            }
