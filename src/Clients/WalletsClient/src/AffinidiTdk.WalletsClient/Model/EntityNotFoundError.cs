...
namespace AffinidiTdk.WalletsClient.Model
{
    ...
    public partial class EntityNotFoundError : IValidatableObject
    {
        ...
        public EntityNotFoundError(NameEnum name = default, MessageEnum message = default, HttpStatusCodeEnum httpStatusCode = default, string traceId = default, List<ServiceErrorResponseDetailsInner> details = default)
        {
            this.Name = name;
