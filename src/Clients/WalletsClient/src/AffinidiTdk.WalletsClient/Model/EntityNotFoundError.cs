...
namespace AffinidiTdk.WalletsClient.Model
{
    ...
    public partial class EntityNotFoundError : IValidatableObject
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        public enum MessageEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "Entity not found")]
            EntityNotFound = 1
        }
        ...
        public EntityNotFoundError(NameEnum name = default, MessageEnum message = default, HttpStatusCodeEnum httpStatusCode = default, string traceId = default, List<NotFoundErrorDetailsInner> details = default)
        {
            this.Name = name;
            ...
            if (traceId == null)
            {
                throw new ArgumentNullException("traceId is a required property for EntityNotFoundError and cannot be null");
            }
