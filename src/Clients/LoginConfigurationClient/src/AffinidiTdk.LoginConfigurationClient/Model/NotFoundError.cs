...
namespace AffinidiTdk.LoginConfigurationClient.Model
{
    ...
    public partial class NotFoundError : IValidatableObject
    {
        ...
        public NotFoundError(NameEnum name = default, MessageEnum message = default, HttpStatusCodeEnum httpStatusCode = default, string traceId = default, List<InvalidParameterErrorDetailsInner> details = default)
        {
            this.Name = name;
