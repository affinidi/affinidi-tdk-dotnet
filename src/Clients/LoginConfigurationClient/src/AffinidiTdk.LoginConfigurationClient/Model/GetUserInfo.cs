...
namespace AffinidiTdk.LoginConfigurationClient.Model
{
    ...
    /// GetUserInfo
    /// </summary>
    [DataContract(Name = "GetUserInfo")]
    public partial class GetUserInfo : IValidatableObject
    {
        /// <summary>
        ...
        public GetUserInfo(string birthdate = default, string email = default, bool emailVerified = default, string familyName = default, string gender = default, string givenName = default, string locale = default, string middleName = default, string name = default, string nickname = default, string phoneNumber = default, bool phoneNumberVerified = default, string picture = default, string preferredUsername = default, string profile = default, string sub = default, int updatedAt = default, string website = default, string zoneinfo = default)
        {
