...
namespace AffinidiTdk.LoginConfigurationClient.Model
{
    ...
    /// JsonWebKeyKeysInner
    /// </summary>
    [DataContract(Name = "JsonWebKey_keys_inner")]
    public partial class JsonWebKeyKeysInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonWebKeyKeysInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonWebKeyKeysInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonWebKeyKeysInner" /> class.
        /// </summary>
        ...
        /// <param name="x5c">The \&quot;x5c\&quot; (X.509 certificate chain) parameter contains a chain of one  or more PKIX certificates [RFC5280]. The certificate chain is represented  as a JSON array of certificate value strings. Each string in the array is  a base64-encoded (Section 4 of [RFC4648] - - not base64url-encoded) DER [ITU.X690.1994] PKIX certificate value. The PKIX certificate containing the  key value MUST be the first certificate.  (required).</param>
        /// <param name="y">y.</param>
        public JsonWebKeyKeysInner(string alg = default, string crv = default, string d = default, string dp = default, string dq = default, string e = default, string k = default, string kid = default, string kty = default, string n = default, string p = default, string q = default, string qi = default, string use = default, string x = default, List<string> x5c = default, string y = default)
        {
            // to ensure "alg" is required (not null)
            if (alg == null)
            {
                throw new ArgumentNullException("alg is a required property for JsonWebKeyKeysInner and cannot be null");
            }
            this.Alg = alg;
            // to ensure "kid" is required (not null)
            if (kid == null)
            {
                throw new ArgumentNullException("kid is a required property for JsonWebKeyKeysInner and cannot be null");
            }
            this.Kid = kid;
            // to ensure "kty" is required (not null)
            if (kty == null)
            {
                throw new ArgumentNullException("kty is a required property for JsonWebKeyKeysInner and cannot be null");
            }
            this.Kty = kty;
            // to ensure "use" is required (not null)
            if (use == null)
            {
                throw new ArgumentNullException("use is a required property for JsonWebKeyKeysInner and cannot be null");
            }
            this.Use = use;
            // to ensure "x5c" is required (not null)
            if (x5c == null)
            {
                throw new ArgumentNullException("x5c is a required property for JsonWebKeyKeysInner and cannot be null");
            }
            this.X5c = x5c;
            this.Crv = crv;
            this.D = d;
        ...
        [DataMember(Name = "x5c", IsRequired = true, EmitDefaultValue = true)]
