...
namespace AffinidiTdk.LoginConfigurationClient.Model
{
    ...
    public partial class OIDCConfig : IValidatableObject
    {
        ...
        public OIDCConfig(string authorizationEndpoint = default, bool backchannelLogoutSessionSupported = default, bool backchannelLogoutSupported = default, bool claimsParameterSupported = default, List<string> claimsSupported = default, List<string> codeChallengeMethodsSupported = default, string credentialsEndpointDraft00 = default, List<OIDCConfigCredentialsSupportedDraft00Inner> credentialsSupportedDraft00 = default, string endSessionEndpoint = default, bool frontchannelLogoutSessionSupported = default, bool frontchannelLogoutSupported = default, List<string> grantTypesSupported = default, List<string> idTokenSignedResponseAlg = default, List<string> idTokenSigningAlgValuesSupported = default, string issuer = default, string jwksUri = default, string registrationEndpoint = default, List<string> requestObjectSigningAlgValuesSupported = default, bool requestParameterSupported = default, bool requestUriParameterSupported = default, bool requireRequestUriRegistration = default, List<string> responseModesSupported = default, List<string> responseTypesSupported = default, string revocationEndpoint = default, List<string> scopesSupported = default, List<string> subjectTypesSupported = default, string tokenEndpoint = default, List<string> tokenEndpointAuthMethodsSupported = default, string userinfoEndpoint = default, List<string> userinfoSignedResponseAlg = default, List<string> userinfoSigningAlgValuesSupported = default)
        {
            // to ensure "authorizationEndpoint" is required (not null)
            if (authorizationEndpoint == null)
            {
                throw new ArgumentNullException("authorizationEndpoint is a required property for OIDCConfig and cannot be null");
            }
            this.AuthorizationEndpoint = authorizationEndpoint;
            // to ensure "idTokenSignedResponseAlg" is required (not null)
            if (idTokenSignedResponseAlg == null)
            {
                throw new ArgumentNullException("idTokenSignedResponseAlg is a required property for OIDCConfig and cannot be null");
            }
            this.IdTokenSignedResponseAlg = idTokenSignedResponseAlg;
            // to ensure "idTokenSigningAlgValuesSupported" is required (not null)
            if (idTokenSigningAlgValuesSupported == null)
            {
                throw new ArgumentNullException("idTokenSigningAlgValuesSupported is a required property for OIDCConfig and cannot be null");
            }
            ...
            if (jwksUri == null)
            {
                throw new ArgumentNullException("jwksUri is a required property for OIDCConfig and cannot be null");
            }
            this.JwksUri = jwksUri;
            // to ensure "responseTypesSupported" is required (not null)
            if (responseTypesSupported == null)
            {
                throw new ArgumentNullException("responseTypesSupported is a required property for OIDCConfig and cannot be null");
            }
            this.ResponseTypesSupported = responseTypesSupported;
            // to ensure "subjectTypesSupported" is required (not null)
            if (subjectTypesSupported == null)
            {
                throw new ArgumentNullException("subjectTypesSupported is a required property for OIDCConfig and cannot be null");
            }
            this.SubjectTypesSupported = subjectTypesSupported;
            // to ensure "tokenEndpoint" is required (not null)
            if (tokenEndpoint == null)
            {
                throw new ArgumentNullException("tokenEndpoint is a required property for OIDCConfig and cannot be null");
            }
            this.TokenEndpoint = tokenEndpoint;
            // to ensure "userinfoSignedResponseAlg" is required (not null)
            if (userinfoSignedResponseAlg == null)
            {
                throw new ArgumentNullException("userinfoSignedResponseAlg is a required property for OIDCConfig and cannot be null");
            }
        ...
        public List<OIDCConfigCredentialsSupportedDraft00Inner> CredentialsSupportedDraft00 { get; set; }
