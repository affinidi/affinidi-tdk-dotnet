...
namespace AffinidiTdk.IamClient.Model
{
    ...
    public partial class UnexpectedError : IValidatableObject
    {
        ...
        public UnexpectedError(NameEnum name = default, MessageEnum message = default, HttpStatusCodeEnum httpStatusCode = default, string traceId = default, List<UnexpectedErrorDetailsInner> details = default)
        {
            this.Name = name;
