...
namespace AffinidiTdk.IamClient.Model
{
    ...
    public partial class ProjectDto : IValidatableObject
    {
        ...
        /// <param name="identityVerificationEnabled">identityVerificationEnabled.</param>
        ...
        public ProjectDto(string id = default, string name = default, string ownerId = default, string description = default, bool identityVerificationEnabled = default, string createdAt = default, string updatedAt = default)
        {
        ...
        /// <summary>
        /// Gets or Sets IdentityVerificationEnabled
        /// </summary>
