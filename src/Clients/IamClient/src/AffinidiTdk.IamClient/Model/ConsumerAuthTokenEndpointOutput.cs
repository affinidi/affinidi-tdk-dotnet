...
namespace AffinidiTdk.IamClient.Model
{
    ...
    public partial class ConsumerAuthTokenEndpointOutput : IValidatableObject
    {
        ...
        public ConsumerAuthTokenEndpointOutput(string accessToken = default, long expiresIn = default, long idToken = default, string refreshToken = default, string scope = default, string tokenType = default)
        {
