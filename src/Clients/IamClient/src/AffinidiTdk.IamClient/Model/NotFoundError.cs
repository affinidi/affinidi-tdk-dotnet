...
namespace AffinidiTdk.IamClient.Model
{
    ...
    public partial class NotFoundError : IValidatableObject
    {
        ...
        public NotFoundError(NameEnum name = default, MessageEnum message = default, HttpStatusCodeEnum httpStatusCode = default, string traceId = default, List<UnexpectedErrorDetailsInner> details = default)
        {
            this.Name = name;
