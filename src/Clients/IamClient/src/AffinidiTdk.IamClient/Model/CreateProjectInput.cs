...
namespace AffinidiTdk.IamClient.Model
{
    ...
    /// CreateProjectInput
    /// </summary>
    [DataContract(Name = "CreateProjectInput")]
    public partial class CreateProjectInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateProjectInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProjectInput" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="description">description.</param>
        public CreateProjectInput(string name = default, string description = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateProjectInput and cannot be null");
            }
            this.Name = name;
