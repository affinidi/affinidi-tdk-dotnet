...
namespace AffinidiTdk.VaultDataManagerClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDetailedNodeInfoOK")]
    public partial class GetDetailedNodeInfoOK : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDetailedNodeInfoOK" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetDetailedNodeInfoOK() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDetailedNodeInfoOK" /> class.
        /// </summary>
        ...
        public GetDetailedNodeInfoOK(string nodeId = default, NodeStatus status = default, decimal fileCount = default, decimal profileCount = default, decimal folderCount = default, decimal vcCount = default, string name = default, string consumerId = default, string parentNodeId = default, string profileId = default, string createdAt = default, string modifiedAt = default, string createdBy = default, string modifiedBy = default, string description = default, NodeType type = default, string link = default, string schema = default, decimal consumedFileStorage = default, EdekInfo edekInfo = default, string metadata = default, string getUrl = default)
        {
            // to ensure "nodeId" is required (not null)
            if (nodeId == null)
            {
                throw new ArgumentNullException("nodeId is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.NodeId = nodeId;
            this.Status = status;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.Name = name;
            // to ensure "consumerId" is required (not null)
            if (consumerId == null)
            {
                throw new ArgumentNullException("consumerId is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.ConsumerId = consumerId;
            // to ensure "parentNodeId" is required (not null)
            if (parentNodeId == null)
            {
                throw new ArgumentNullException("parentNodeId is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.ParentNodeId = parentNodeId;
            // to ensure "profileId" is required (not null)
            if (profileId == null)
            {
                throw new ArgumentNullException("profileId is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.ProfileId = profileId;
            // to ensure "createdAt" is required (not null)
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "modifiedAt" is required (not null)
            if (modifiedAt == null)
            {
                throw new ArgumentNullException("modifiedAt is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.ModifiedAt = modifiedAt;
            // to ensure "createdBy" is required (not null)
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
            this.CreatedBy = createdBy;
            // to ensure "modifiedBy" is required (not null)
            if (modifiedBy == null)
            {
                throw new ArgumentNullException("modifiedBy is a required property for GetDetailedNodeInfoOK and cannot be null");
            }
        ...
        /// Gets or Sets GetUrl
        /// </summary>
        [DataMember(Name = "getUrl", EmitDefaultValue = false)]
