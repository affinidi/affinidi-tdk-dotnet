...
namespace AffinidiTdk.VaultDataManagerClient.Model
{
    ...
    /// UpdateAccountDto
    /// </summary>
    [DataContract(Name = "UpdateAccountDto")]
    public partial class UpdateAccountDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAccountDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountDto" /> class.
        /// </summary>
        ...
        public UpdateAccountDto(decimal accountIndex = default, string accountDid = default, Object metadata = default)
        {
            this.AccountIndex = accountIndex;
            // to ensure "accountDid" is required (not null)
            if (accountDid == null)
            {
                throw new ArgumentNullException("accountDid is a required property for UpdateAccountDto and cannot be null");
            }
