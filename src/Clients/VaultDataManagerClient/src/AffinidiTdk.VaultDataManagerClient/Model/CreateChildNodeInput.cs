...
namespace AffinidiTdk.VaultDataManagerClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateChildNodeInput")]
    public partial class CreateChildNodeInput : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildNodeInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateChildNodeInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChildNodeInput" /> class.
        /// </summary>
        ...
        public CreateChildNodeInput(string name = default, NodeType type = default, string description = default, EdekInfo edekInfo = default, string dek = default, string metadata = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateChildNodeInput and cannot be null");
            }
            this.Name = name;
            this.Type = type;
