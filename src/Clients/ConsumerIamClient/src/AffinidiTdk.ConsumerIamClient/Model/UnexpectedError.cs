...
namespace AffinidiTdk.ConsumerIamClient.Model
{
    ...
    public partial class UnexpectedError : IValidatableObject
    {
        ...
        public UnexpectedError(NameEnum name = default, MessageEnum message = default, HttpStatusCodeEnum httpStatusCode = default, string traceId = default, List<InvalidJwtTokenErrorDetailsInner> details = default)
        {
            this.Name = name;
