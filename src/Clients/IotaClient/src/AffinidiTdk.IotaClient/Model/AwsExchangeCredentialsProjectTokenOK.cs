...
namespace AffinidiTdk.IotaClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsExchangeCredentialsProjectTokenOK")]
    public partial class AwsExchangeCredentialsProjectTokenOK : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsExchangeCredentialsProjectTokenOK" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AwsExchangeCredentialsProjectTokenOK() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsExchangeCredentialsProjectTokenOK" /> class.
        /// </summary>
        /// <param name="connectionClientId">connectionClientId (required).</param>
        /// <param name="credentials">credentials (required).</param>
        public AwsExchangeCredentialsProjectTokenOK(string connectionClientId = default, AwsExchangeCredentialsProjectTokenOKCredentials credentials = default)
        {
            // to ensure "connectionClientId" is required (not null)
            if (connectionClientId == null)
            {
                throw new ArgumentNullException("connectionClientId is a required property for AwsExchangeCredentialsProjectTokenOK and cannot be null");
            }
            this.ConnectionClientId = connectionClientId;
            // to ensure "credentials" is required (not null)
            if (credentials == null)
            {
                throw new ArgumentNullException("credentials is a required property for AwsExchangeCredentialsProjectTokenOK and cannot be null");
            }
